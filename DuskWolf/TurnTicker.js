...
dusk.load.provide("dusk.TurnTicker");
 ...
 * @since 0.0.21-alpha
 */
dusk.TurnTicker = function(order) {
	/** The turn order. Value is one of the `dusk.TurnTicker.ORDER_*` constants.
	 * @type int
	 */
	this.order = order?order:dusk.TurnTicker.ORDER_ADDED;
 ...
 */
dusk.TurnTicker.prototype.register = function(name, onTurn, orderObj) {
 ...
 */
dusk.TurnTicker.prototype.remove = function(name) {
 ...
 * @private
 */
dusk.TurnTicker.prototype._removeById = function(id) {
 ...
 */
dusk.TurnTicker.prototype.ensureOrder = function() {
	return new Promise((function(fulfill, reject) {
		if(this.order == dusk.TurnTicker.ORDER_ADDED) {
			// Do nothing
			fulfill(true);
		}
	}).bind(this));
 ...
 */
dusk.TurnTicker.prototype.start = function() {
	this._turn = -1;
	this._stop = false;
 ...
 */
dusk.TurnTicker.prototype.stop = function() {
	this._stop = true;
};
 ...
 * @private
 */
dusk.TurnTicker.prototype._next = function(fulfill) {
 ...
 */
dusk.TurnTicker.prototype.length = function() {
 ...
 */
dusk.TurnTicker.prototype.toString = function() {
	return "[TurnTaker]";
};
