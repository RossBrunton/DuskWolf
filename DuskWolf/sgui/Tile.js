...
sgui.Tile.prototype._tileDraw = function(c) {
	if(this._img){
		if(this._width != this._theight || this._height != this._theight){
			/*if(navigator.userAgent.indexOf(" Chrome/") != -1 || navigator.userAgent.indexOf(" MSIE ") != -1){
				...
				c.drawImage(this._img, this._tx*this._twidth, this._ty*this._theight, this._twidth, this._theight, 0, 0, this.getWidth()?this.getWidth():this._twidth, this.getHeight()?this.getHeight():this._theight);
			//}
		}else{
			c.drawImage(this._img, this._tx*this._twidth, this._ty*this._theight, this._twidth, this._theight, 0, 0, this._twidth, this._theight);
		}
	}
};
