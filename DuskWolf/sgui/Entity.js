...
dusk.load.provide("dusk.entities.LightEntity");
...
dusk.sgui.Entity = function(parent, comName) {
	if(!this.isLight()) dusk.sgui.Tile.call(this, parent, comName);
 ...
 */
dusk.sgui.Entity.prototype._aniAction = function(event, action) {
 ...
 * @return {*} The result of the evaluated parse tree.
 */
dusk.sgui.Entity.prototype.evalTrigger = function(trigger, event) {
 ...
 */
dusk.sgui.Entity.prototype.animationWait = function(name, funct) {
 ...
 */
dusk.sgui.Entity.prototype.isLight = function() {
	return false;
};
 ...
 * @constructor
 */
dusk.entities.LightEntity = function(type) {
	dusk.sgui.Entity.call(this, null, null);
	
	this.entType = type;
	this.deleted = false;
};

for(var p in dusk.sgui.Entity.prototype) {
	if(dusk.sgui.Entity.prototype.hasOwnProperty(p)
	&& ["className", "schemePath", "particlesPath", "entType"].indexOf(p) === -1)
		dusk.entities.LightEntity.prototype[p] = dusk.sgui.Entity.prototype[p];
}
 ...
 */
dusk.entities.LightEntity.prototype.isLight = function() {
	return true;
};

//Basic getters and setters, I see no way to copy these from the original
//schemePath
Object.defineProperty(dusk.entities.LightEntity.prototype, "schemePath", {
	get: function() {
		return this.scheme?this.scheme.fullPath():undefined;
	},
...
//particlesPath
Object.defineProperty(dusk.entities.LightEntity.prototype, "particlesPath", {
	get: function() {
		return this.particles?this.particles.fullPath():undefined;
	},
...
//entType
Object.defineProperty(dusk.entities.LightEntity.prototype, "entType", {
	get: function() {
		return this._type;
	},
