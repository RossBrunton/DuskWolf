...
load.provide("test", function() {
	...
	class Tester {
		 ...
		 *
		 * @param {string} pack The package name to test
		 */
		constructor(pack) {
			/** The package name
			 * @type string
			 * @memberof! test.Tester#
			 */
			this.package = pack;
			/** Whether the test has failed or not
			 * @type boolean
			 * @memberof! test.Tester#
			 */
			this.failed = false;
