...
load.provide("dusk.utils.Image", function() {
	...
	class Image {
		...
		asCanvas(extraTrans, ignoreNormalTrans) {
		...
		paint(ctx, extraTrans, ino, ox, oy, owidth, oheight, dx, dy, dwidth, dheight) {
			if(this._proxy) {
		...
		paintFull(ctx, extraTrans, ino, dx, dy, dwidth, dheight) {
			if(this._proxy) {
				this._proxy.paint(
		...
		paintRanges(ctx, extraTrans, ino, origin, slice, dest) {
			if(this._proxy) {
		...
		paintRangesTile(ctx, extraTrans, ino, origin, slice, dest, tx, ty, twidth, theight) {
		...
		paintScaled(ctx, extraTrans, ino, ox, oy, owidth, oheight, dx, dy, dwidth, dheight, sx, sy) {
