...
load.provide("dusk.sgui.Group", function() {
	...
	class Group extends Component {
		...
		constructor(parent, name) {
			...
			this._mapper.map("children", [this._groupChildrenGetter, this.modifyComponent], ["focusBehaviour"]);
			this._mapper.map("allChildren", [this._groupChildrenGetter, this.modifyAllChildren], ["focusBehaviour", "children"]);
			this._mapper.map("mouseFocus", "mouseFocus");
