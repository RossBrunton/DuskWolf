...
load.provide("dusk.rooms.RoomTransitions", function() {
	...
	var RoomTransitions = function(data, room, manager) {
		this.roomName = room;
	...
	RoomTransitions.prototype.destroy = function() {
		for(var l of this._listenersToUnlink) {
			l[0].unlisten(l[1]);
		};
	};
	
	RoomTransitions.prototype.export = function() {
		return {
	...
	RoomTransitions.prototype.add = function(trigger, transition, dest) {
		this._transitions.push([trigger, transition, dest]);
	};
	
	RoomTransitions.prototype.remove = function(i) {
		this._transitions.splice(i, 1);
	};
	
	RoomTransitions.prototype.setNewRoom = function(newRoom) {
		this._newRoom = newRoom;
	};
	
	RoomTransitions.prototype._go = function(tran) {
	...
	RoomTransitions.prototype.newRoom = function() {
		var chain = Promise.resolve(true);
	...
	RoomTransitions.prototype._addListener = function(ed, fn) {
