...
load.provide("dusk.sgui.TextBox", function() {
	...
	/** A textbox is an instance of `{@link dusk.sgui.Label}` that allows the user to change the text inside
	 * it when active.
	 * 
	...
	class TextBox extends ValidatingLabel {
		...
		constructor(parent, name) {
			 ...
			 * @type string
			 * @default "#cccccc"
			 * @memberof! dusk.text.sgui.TextBox#
			 */
			this.border = "#cccccc";
			...
			//Listeners
			this.onPaint.listen(this._tbDraw.bind(this));
			this.onInteract.listen(this._tbKey.bind(this), interaction.KEY_DOWN);
			this.onActiveChange.listen(this._tbActiveChange.bind(this));
...
load.provide("dusk.sgui.NumberBox", function() {
	...
	/** A number box is a textbox designed for inputting numbers.
	 * 
	 ...
	 * @extends dusk.text.sgui.TextBox
	 * @constructor
	 */
	class NumberBox extends TextBox {
		/** Creates a new NumberBox component
		 *
		 * @param {dusk.sgui.Group} parent The container that this component is in.
		 * @param {string} name The name of the component.
		 */
		constructor(parent, name) {
			 ...
			 * @private
			 * @memberof! dusk.text.sgui.NumberBox#
			 */
			this._range = null;
			...
			this.dirPress.listen(this._dirPress.bind(this));
			this.onChange.listen(this._onChange.bind(this));
			this.postChange.listen(this._postChange.bind(this));
