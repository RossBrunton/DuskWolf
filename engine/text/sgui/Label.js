...
/** Various sgui components for the text module
 *
 * @name sgui
 * @memberof dusk.text
 * @namespace
	 ...
	 */
	 class Label extends Component {
		...
		constructor(parent, name) {
			...
			//Listeners
			this.onPaint.listen(this._labelDraw.bind(this));
		}
...
load.provide("dusk.text.sgui.ValidatingLabel", function() {
	 ...
	 * @memberof dusk.text.sgui
	 */
	class ValidatingLabel extends Label {
		/** Creates a new Validating Label
		 *
		 * @param {dusk.sgui.Group} parent The container that this component is in.
		 * @param {string} name The name of the component.
		 */
		constructor(parent, name) {
			 ...
			 * @default null
			 * @since 0.0.21-alpha
			 * @memberof! dusk.text.sgui.ValidatingLabel#
			 */
			...
			//Listeners
			this.onActiveChange.listen(this._activeChange.bind(this), false);
			this.onChange.listen(this._textChange.bind(this));
		}
