...
/** SGui components for the particles system.
 *
 * @namespace
...
load.provide("dusk.particles.sgui.ParticleField", function() {
	 ...
	 * @memberof dusk.particles.sgui
	 */
	class ParticleField extends Component {
		/** Creates a new particle field
		 * 
		...
		inject(r, g, b, a, x, y, dx, dy, ddx, ddy, dxlimit, dylimit, lifespan, decay) {
			if(a == 0) return;
