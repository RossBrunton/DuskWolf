...
load.provide("dusk.tiles.Weights", function() {
	 ...
	 */
	class Weights {
		/** Creates a new Weights instance
		 * 
		 * @param {integer} rows The number of rows in the source map.
		 * @param {integer} cols The number of columns in the source map.
		 */
		...
		describe(arr, cols, rows, feTop, feBottom) {
			var outstr = "";
