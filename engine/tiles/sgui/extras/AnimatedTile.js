...
load.provide("dusk.tiles.sgui.extras.animationTypes", function() {
	 ...
	 * 
	 * @since 0.0.21-alpha
	 * @memberof dusk.tiles.sgui.extras
	 * @namespace
	 */
	var types = {};
	 ...
	 * @param {boolean=} block Iff false, then the next action will be executed immediately. Otherwise, the full
...
load.provide("dusk.tiles.sgui.extras.AnimatedTile", function() {
	 ...
	 * @memberof dusk.tiles.sgui.extras
	 */
	class AnimatedTile extends Extra { 
		/** Creates a new AnimatedTile
		 * 
		...
		constructor(owner, name) {
			 ...
			 * @type array<array>
			 * @private
			 * @memberof! dusk.tiles.sgui.extras.AnimatedTile#
			 */
			this._animations = [];
			...
			/** The delay between frames, in "real" frames. Higher numbers indicate a slower animation, with 60 being
			 * one frame a second.
			 * 
			 * @default 5
			 * @type integer
			...
			//Listeners
			this._atFrameId = this._owner.frame.listen(this._onFrame.bind(this));
			this.onDelete.listen(this._deleted.bind(this));
		 ...
		 * 
		 * @param {string} name The string name of the animation to set.
		 ...
		 * 
		 * @param {(object|array<integer>|function(object, dusk.sgui.Tile):*)} act The action object.
