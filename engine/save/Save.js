...
load.provide("dusk.save", (function() {
	 ...
	 */
	save.SaveSpec.prototype.add = function(pack, type, args) {
	...
	return save;
})(), {"alsoSeal":["SaveIntegrityError", "SaveSpec", "SaveSource", "SaveData", "ISavable", "IRefSavable"]});
