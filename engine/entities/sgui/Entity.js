...
load.provide("dusk.entities.sgui.Entity", function() {
	...
	class Entity extends Tile {
		...
		constructor(parent, name) {
			 ...
			 * @type integer
			 * @since 0.0.21-alpha
			 * @memberof! dusk.entities.sgui.Entity#
			 * @readonly
			 */
			this.dx = 0;
			 ...
			 */
			this._behaviours = {};
			/** Listeners for classless behaviours. Key is behavour event name, and value is an array of functions to
			 * call.
			 * @type object
			 * @private
			 * @since 0.0.21-alpha
			...
			/** The entity's behaviour data. This is data used by the entity's behaviour objects. It contains stuff such
			 * as gravity. This is set with the entity's type.
			 * @type object
			 * @memberof! dusk.entities.sgui.Entity#
			 * @private
			 */
		 ...
		 * @since 0.0.21-alpha
		 */
		_sum(arr, base, accum, lowCollide, highCollide) {
			var out = 0;
		 ...
		 */
		behaviourFireWithReturn(event, data) {
			var output = [];
			if(!data) data = {};
			data.name = event;
		 ...
		 */
		behaviourFireWithPass(event, data) {
			if(!data) data = {};
			data.name = event;
		 ...
		 * @param {boolean=} reInit If the behaviour already exists and this is true, it will be
